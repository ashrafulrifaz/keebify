import AddProduct from '@/components/DashboardComp/AddProduct/AddProduct';
    ...
    return (
        <div className='px-6 py-4'>
            <div className='flex items-start gap-5'>
                ...
                <div>
                    <h2 className='capitalize text-2xl font-medium'>Create Product</h2>
                    <p className='text-[#414141] mt-2'>create a new product</p>
                </div>
            </div>
            <AddProduct />
        </div>
