...
const BrandSelector = ({brand, setBrand}) => {
    ...
    return (
        <div className="relative block mt-3" ref={ref}>
            ...
            {open && (
                <div className="absolute right-0 mt-2 w-full bg-white rounded-2xl border border-border shadow-lg shadow-black/5 py-2 z-20 h-80 overflow-y-auto brand-scroll">
                    {BRANDS.map((category) => (
                        <button
                            key={category}
                            type="button"
