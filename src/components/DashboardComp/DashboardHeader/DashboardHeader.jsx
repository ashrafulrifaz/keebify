        ...
        <div className='grid grid-cols-3 gap-5 items-center px-6 py-3'>
            ...
            <div className='flex justify-end items-center gap-2'>
                ...
                <div className='relative'>
                    <div onClick={() => setOpen((prev) => !prev)} className='border border-border p-0.5 bg-secondary rounded-full flex items-center gap-2'>
                    ...
                    {open && (
                        <div className="absolute right-0 mt-2 w-40 bg-white rounded-2xl border border-border shadow-lg shadow-black/5 z-20 py-1 overflow-hidden">
                            <button className='px-3 py-2 hover:bg-gray-100 w-full text-[15px] cursor-pointer'>Profile</button>
                            <button className='px-3 py-2 hover:bg-gray-100 w-full text-[15px] cursor-pointer' onClick={() => signOut()}>Log Out</button>
                        </div>
                    )}
                </div>
            </div>
