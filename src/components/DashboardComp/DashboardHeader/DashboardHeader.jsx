    ...
    return (
        <div className='grid grid-cols-3 gap-5 items-center px-6 py-3'>
            ...
            <div className='flex justify-end items-center gap-2'>
                <Link href="/profile" className='border border-border p-2 bg-secondary rounded-full'>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20" color="#141b34" fill="none" stroke="#141b34" stroke-width="1.5">
                        <path d="M16 18C16 20.2091 14.2091 22 12 22C9.79086 22 8 20.2091 8 18" stroke-linecap="round" stroke-linejoin="round"></path>
                ...
                <div className='border border-border p-0.5 bg-secondary rounded-full flex items-center gap-2'>
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20" color="#141b34" fill="none" stroke="#141b34" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
